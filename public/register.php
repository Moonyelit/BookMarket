...
<head>
  ...
  <link rel="stylesheet" href="./assets/CSS/AutreCSS/register.css">
  ...
  <script defer src="./assets/Javascript/register.js"></script>
  ...
  <main class="p-6 min-h-screen flex items-center justify-center flex-col">
    ...
    <div class="bg-brown p-8 rounded-3xl shadow-xl w-full max-w-lg">
      ...
      <form id="registration-form" action="../process/userInscription.php" method="POST" class="space-y-4" enctype="multipart/form-data">
        ...
        <div>
          <label for="user-password" class="block text-yellow mb-1">Mot de passe</label>
          <input type="password" id="user-password" name="password" class="w-full p-2 rounded bg-white text-black" required maxlength="30">
        </div>
        <div>
